...
TERMUX_PKG_SRCURL="https://git.joeyh.name/index.cgi/git-annex.git/snapshot/git-annex-$TERMUX_PKG_VERSION.tar.gz"
TERMUX_PKG_SHA256=1a713106b5975e1622a804a3a0448988305e505ef91e171be9a1963b17e97f91
TERMUX_PKG_AUTO_UPDATE=false
TERMUX_PKG_BUILD_IN_SRC=true
TERMUX_PKG_DEPENDS="zlib, libffi, libiconv, libgmp, libandroid-posix-semaphore, libandroid-utimes, libsqlite, botan3"
